...
# Common parameters
CACHE_DIR=""
SCRIPT="./scripts/interpret_attn.py"
...
declare -A models
models=(
    ["meta-llama/Llama-3.2-3B-Instruct"]="5000 1 0.875 1.0"
    ["Qwen/Qwen2.5-1.5B-Instruct"]="5000 1 0.625 1.0"
    ["Qwen/Qwen2.5-Math-1.5B-Instruct"]="5000 1 0.875 1.0"
    ["microsoft/Phi-3-mini-4k-instruct"]="5000 1 0.875 0.75"
)
